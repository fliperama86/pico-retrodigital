/**
 * Thin 8x8 monochrome bitmap font
 *
 * Custom minimal design with 1-pixel strokes for readability on small displays.
 * Public Domain
 *
 * Format: Each character is 8 consecutive bytes (one per row)
...
static const uint8_t font8x8[128][8] = {
    ...
    {0x00, 0x01, 0x02, 0x04, 0x48, 0x30, 0x10, 0x00}, // 0x01 checkmark
    {0x00, 0x42, 0x24, 0x18, 0x18, 0x24, 0x42, 0x00}, // 0x02 X mark
    ...
    // 0x20-0x7E: Printable ASCII (thin 1-pixel strokes)
    ...
    {0x31, 0x32, 0x04, 0x08, 0x10, 0x26, 0x46, 0x00}, // 0x25 '%'
    {0x18, 0x24, 0x18, 0x28, 0x46, 0x44, 0x3A, 0x00}, // 0x26 '&'
    ...
    {0x1C, 0x22, 0x20, 0x2E, 0x22, 0x22, 0x1E, 0x00}, // 0x47 'G'
    ...
    {0x22, 0x22, 0x22, 0x22, 0x14, 0x14, 0x08, 0x00}, // 0x56 'V'
    ...
    {0x0C, 0x10, 0x3C, 0x10, 0x10, 0x10, 0x10, 0x00}, // 0x66 'f'
    ...
    {0x00, 0x00, 0x34, 0x2A, 0x2A, 0x2A, 0x22, 0x00}, // 0x6D 'm'
    ...
    {0x04, 0x08, 0x08, 0x10, 0x08, 0x08, 0x04, 0x00}, // 0x7B '{'
